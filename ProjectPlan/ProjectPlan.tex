...
In chapter \ref{chapProjectEstimations} we present the estimations for the size of the system, for the cost and for the development time. Finally, our project plan is presented in chapter \ref{chapPlan}.
