...
In chapter \ref{chapSizeEstimates} we present the initial estimations for the size of the system based on the Function Points method. Finally, our project plan is presented in chapter \ref{chapPlan}.
