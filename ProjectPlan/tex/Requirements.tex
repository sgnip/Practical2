...
\reqdesc The system provedes a priorities categorization manager which shows the whole list of categories with their assigned priority. It will allow to change values, add new ones, delete them.
